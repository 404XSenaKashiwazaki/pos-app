                ...
                <FormItem className="w-full">
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        field.onChange(e.target.value);
                        const getQuantityValue = form.getValues("quantity");
                        if (getQuantityValue) {
                          const totalAmountValue =
                            Number(getQuantityValue) * Number(e.target.value);
                  ...
                  return (
                    <FormItem className="w-full">
                      ...
                      <FormDescription className="text-sm text-muted-foreground">
                        Tanggal selesai otomatis + 15 hari dari tanggal
                        pemesanan
                      </FormDescription>
                    </FormItem>
                  );
