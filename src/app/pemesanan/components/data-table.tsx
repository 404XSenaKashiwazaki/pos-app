...
export const DataTable = ({ data, customer, handle, sablon }: DataTableProps) => {
  ...
  const table = useReactTable({
    data,
    columns: columns({ customer, handle, sablon }),
  ...
  const showModalAdd = () => {
    sheet({
      ...
      content: <FormPage sablon={sablon} handle={handle} customer={customer} />,
      size: "sm:max-w-2xl",
    });
  };
